...
tags:
  - R
  - eye tracking
description: 'In this post I show my favorite way to import and combine multiple data files into a single R data frame.'
---
...
``` {r, eval = FALSE}
# Read in all files in the current working directory and store the result in 'data'
list.files() %>%
